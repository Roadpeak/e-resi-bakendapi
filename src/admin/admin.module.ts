...
@Module({
  controllers: [AdminController, PricingController, AdminUsersController, AdminPropertiesController, AdminBillingController],
  providers: [AdminService, AuditService, PricingService, AdminUsersService, AdminPropertiesService, AdminBillingService],
