...
@Module({
  controllers: [AdminController, PricingController, AdminUsersController, AdminPropertiesController],
  providers: [AdminService, AuditService, PricingService, AdminUsersService, AdminPropertiesService],
