...
export declare class PropertiesController {
    ...
    findMyProperties(user: {
        id: string;
    }, query: QueryPropertiesDto): Promise<{
        data: ({
            _count: {
                inquiries: number;
                units: number;
    ...
    update(slug: string, user: {
        id: string;
        role: UserRole;
    }, dto: UpdatePropertyDto): Promise<{
        name: string;
        tags: string[];
        description: string | null;
        id: string;
    ...
    setStatus(slug: string, user: {
        id: string;
        role: UserRole;
    }, status: PropertyStatus): Promise<{
        name: string;
        tags: string[];
        description: string | null;
        id: string;
