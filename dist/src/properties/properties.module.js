...
const properties_controller_js_1 = require("./properties.controller.js");
...
exports.PropertiesModule = PropertiesModule = __decorate([
    (0, common_1.Module)({
        controllers: [properties_controller_js_1.PropertiesController],
        providers: [properties_service_js_1.PropertiesService],
        exports: [properties_service_js_1.PropertiesService],
    })
], PropertiesModule);
