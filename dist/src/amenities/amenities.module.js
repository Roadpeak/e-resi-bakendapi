...
const amenities_controller_js_1 = require("./amenities.controller.js");
...
exports.AmenitiesModule = AmenitiesModule = __decorate([
    (0, common_1.Module)({
        controllers: [amenities_controller_js_1.AmenitiesController],
        providers: [amenities_service_js_1.AmenitiesService],
    })
], AmenitiesModule);
